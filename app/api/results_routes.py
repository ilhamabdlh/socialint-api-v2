...
@router.post("/populate-staging-data")
async def populate_staging_data():
    """Populate staging database with sample data for testing"""
    try:
        # Create sample brand
        brand = Brand(
            name="purbaya",
            keywords=["purbaya", "brand", "testing"],
        ...
        sample_posts = [
            Post(
                ...
                text="Great product from Purbaya! Love it!",
                author_name="user1",
                sentiment="Positive",
                ...
                comment_count=25,
                share_count=10,
                post_url="https://tiktok.com/post1",
                posted_at=datetime.now() - timedelta(days=1)
            ),
            Post(
                brand=brand,
                platform=PlatformType.TIKTOK,
                text="Purbaya's new feature is amazing",
                author_name="user2", 
                sentiment="Positive",
                topic="feature_announcement",
                like_count=200,
                comment_count=30,
                share_count=15,
                post_url="https://tiktok.com/post2",
                posted_at=datetime.now() - timedelta(days=2)
            ),
            Post(
                brand=brand,
                platform=PlatformType.INSTAGRAM,
                text="Not sure about Purbaya's pricing",
                author_name="user3",
                sentiment="Negative", 
                topic="pricing_concern",
                like_count=50,
                comment_count=15,
                share_count=5,
                post_url="https://instagram.com/post3",
        ...
        return {
            "message": "Staging data populated successfully",
            "brand": brand.name,
            "posts_created": len(sample_posts),
